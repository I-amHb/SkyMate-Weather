    ...
    <div className='w-[350px] h-[400px] flex flex-col gap-2 justify-evenly shadow-custom rounded-md md:w-[500px] '>
        <div className=' w-full h-[150px] flex'>
            ...
            <div className=' w-2/3 flex items-center justify-end'>
                <img className=' w-[130px] ' src={`http://openweathermap.org/img/wn/${weather[0].icon}@2x.png`} 
                alt="clear-icon" />
            </div>
        </div>
        <div className=' w-full h-[100px] flex flex-col justify-center '>
            <h1 className=' h-full text-[60px] text-center'>{main.temp}℃</h1>
        </div>
        <div className=' w-full h-[100px] flex flex-row justify-evenly items-center '>
            <div className='w-1/2 flex flex-row items-center justify-center '>
                ...
                <div>
                    <h1 className=' text-[23px] '>{main.humidity}%</h1>
            ...
            <div className='w-1/2  flex flex-row items-center justify-center  '>
                <img className='w-[55px] ' src="./assets/wind.png" alt="humidity-icon" />
                    <div>
                        <h1 className=' text-[23px] '>{wind.speed} m/s</h1>
